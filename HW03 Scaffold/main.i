...
void goToWin() {
    ...
    drawString(47, 90, "You slayed all 5 enemies", ((0&31) | (31&31) << 5 | (0&31) << 10));
    state = WIN;
}
...
void goToLose() {
    ...
    drawString(45, 90, "You slayed only   enemies", ((31&31) | (0&31) << 5 | (0&31) << 10));
    drawString(140, 90, buffer, ((31&31) | (0&31) << 5 | (0&31) << 10));
    state = LOSE;
}
